...
from .config import FLUENTQML_RESOURCE_PREFIX


class FluentQMLTranslator(QTranslator):
    """
    FluentQML i18n translator.
    ...
    def load(self, locale: Union[QLocale, str]) -> bool:
        ...
        if not super().load(path):
            ...
            path = f"{FLUENTQML_RESOURCE_PREFIX}/languages/en_US.qm"
